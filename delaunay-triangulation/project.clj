(defproject delaunay-triangulation "0.1.0-SNAPSHOT"
  :description "Delaunay triangulation with provided points"
  ...
  {:dev {:dependencies [[javax.servlet/servlet-api "2.5"]
   ...
   :uberjar {:aot :all}}
  :lambda {:function {:name "lowpoly-delaunay-triangulation"
