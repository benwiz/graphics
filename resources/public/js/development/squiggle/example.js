...
goog.provide('squiggle.example');
goog.require('cljs.core');
goog.require('quil.core');
squiggle.example.setup = (function squiggle$example$setup(){
...
squiggle.example.update_state = (function squiggle$example$update_state(state){
...
squiggle.example.draw_state = (function squiggle$example$draw_state(state){
