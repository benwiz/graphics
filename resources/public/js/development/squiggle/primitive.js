...
quil.core.frame_rate.call(null,(1000));
...
cljs.core.println.call(null,"count:",cljs.core.count.call(null,new cljs.core.Keyword(null,"shapes","shapes",1897594879).cljs$core$IFn$_invoke$arity$1(state)));

return new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"i","i",-1386841315),(((new cljs.core.Keyword(null,"i","i",-1386841315).cljs$core$IFn$_invoke$arity$1(state) < squiggle.primitive.max_i))?(new cljs.core.Keyword(null,"i","i",-1386841315).cljs$core$IFn$_invoke$arity$1(state) + (1)):(0)),new cljs.core.Keyword(null,"target-image","target-image",1796431459),new cljs.core.Keyword(null,"target-image","target-image",1796431459).cljs$core$IFn$_invoke$arity$1(state),new cljs.core.Keyword(null,"prediction-pixels","prediction-pixels",-506822864),prediction_pixels,new cljs.core.Keyword(null,"shapes","shapes",1897594879),(((new cljs.core.Keyword(null,"i","i",-1386841315).cljs$core$IFn$_invoke$arity$1(state) < squiggle.primitive.max_i))?new cljs.core.Keyword(null,"shapes","shapes",1897594879).cljs$core$IFn$_invoke$arity$1(state):cljs.core.conj.call(null,new cljs.core.Keyword(null,"shapes","shapes",1897594879).cljs$core$IFn$_invoke$arity$1(state),new cljs.core.Keyword(null,"best-shape","best-shape",2048427545).cljs$core$IFn$_invoke$arity$1(state))),new cljs.core.Keyword(null,"next-shape","next-shape",103541154),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.rand_int.call(null,quil.core.width.call(null)),cljs.core.rand_int.call(null,quil.core.height.call(null)),Math.max(cljs.core.rand_int.call(null,quil.core.width.call(null)),(10)),Math.max(cljs.core.rand_int.call(null,quil.core.height.call(null)),(10)),cljs.core.rand_int.call(null,(255)),cljs.core.rand_int.call(null,(255)),cljs.core.rand_int.call(null,(255))], null),new cljs.core.Keyword(null,"best-shape","best-shape",2048427545),(((mse < new cljs.core.Keyword(null,"best-mse","best-mse",-2132718887).cljs$core$IFn$_invoke$arity$1(state)))?new cljs.core.Keyword(null,"next-shape","next-shape",103541154).cljs$core$IFn$_invoke$arity$1(state):new cljs.core.Keyword(null,"best-shape","best-shape",2048427545).cljs$core$IFn$_invoke$arity$1(state)),new cljs.core.Keyword(null,"best-mse","best-mse",-2132718887),(((new cljs.core.Keyword(null,"i","i",-1386841315).cljs$core$IFn$_invoke$arity$1(state) < squiggle.primitive.max_i))?(((mse < new cljs.core.Keyword(null,"best-mse","best-mse",-2132718887).cljs$core$IFn$_invoke$arity$1(state)))?mse:new cljs.core.Keyword(null,"best-mse","best-mse",-2132718887).cljs$core$IFn$_invoke$arity$1(state)):(9007199254740991))], null);
});
...
//# sourceMappingURL=primitive.js.map?rel=1526523455692
