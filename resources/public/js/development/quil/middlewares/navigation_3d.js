...
var vec__22621 = axis;
var a_x = cljs.core.nth.call(null,vec__22621,(0),null);
var a_y = cljs.core.nth.call(null,vec__22621,(1),null);
var a_z = cljs.core.nth.call(null,vec__22621,(2),null);
var vec__22624 = v;
var x = cljs.core.nth.call(null,vec__22624,(0),null);
var y = cljs.core.nth.call(null,vec__22624,(1),null);
var z = cljs.core.nth.call(null,vec__22624,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__22627,p__22628){
var vec__22629 = p__22627;
var u1 = cljs.core.nth.call(null,vec__22629,(0),null);
var u2 = cljs.core.nth.call(null,vec__22629,(1),null);
var u3 = cljs.core.nth.call(null,vec__22629,(2),null);
var vec__22632 = p__22628;
var v1 = cljs.core.nth.call(null,vec__22632,(0),null);
var v2 = cljs.core.nth.call(null,vec__22632,(1),null);
var v3 = cljs.core.nth.call(null,vec__22632,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__22635_SHARP_){
return (p1__22635_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__22636_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__22637_SHARP_,angle_lr),angle_ud);
...
var map__22639 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__22639__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__22639__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__22641 = cljs.core._EQ_;
var expr__22642 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__22641.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__22642))){
return straight;
} else {
if(cljs.core.truth_(pred__22641.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__22642))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__22641.call(null,quil.middlewares.navigation_3d.space,expr__22642))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__22641.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__22642))){
return up;
} else {
if(cljs.core.truth_(pred__22641.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__22642))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__22641.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__22642))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__22639,map__22639__$1,up,straight){
return (function (p1__22638_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__22638_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__22639,map__22639__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__22644_SHARP_);
});})(initial_state))
);
});
/**
...
var map__22645_22656 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__22645_22657__$1 = ((((!((map__22645_22656 == null)))?(((((map__22645_22656.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22645_22656.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22645_22656):map__22645_22656);
var vec__22646_22658 = cljs.core.get.call(null,map__22645_22657__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_22659 = cljs.core.nth.call(null,vec__22646_22658,(0),null);
var c_y_22660 = cljs.core.nth.call(null,vec__22646_22658,(1),null);
var c_z_22661 = cljs.core.nth.call(null,vec__22646_22658,(2),null);
var vec__22649_22662 = cljs.core.get.call(null,map__22645_22657__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_22663 = cljs.core.nth.call(null,vec__22649_22662,(0),null);
var u_y_22664 = cljs.core.nth.call(null,vec__22649_22662,(1),null);
var u_z_22665 = cljs.core.nth.call(null,vec__22649_22662,(2),null);
var vec__22652_22666 = cljs.core.get.call(null,map__22645_22657__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_22667 = cljs.core.nth.call(null,vec__22652_22666,(0),null);
var p_y_22668 = cljs.core.nth.call(null,vec__22652_22666,(1),null);
var p_z_22669 = cljs.core.nth.call(null,vec__22652_22666,(2),null);
quil.core.camera.call(null,p_x_22667,p_y_22668,p_z_22669,(p_x_22667 + c_x_22659),(p_y_22668 + c_y_22660),(p_z_22669 + c_z_22661),u_x_22663,u_y_22664,u_z_22665);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1525651789521
