...
var vec__1809 = axis;
var a_x = cljs.core.nth.call(null,vec__1809,(0),null);
var a_y = cljs.core.nth.call(null,vec__1809,(1),null);
var a_z = cljs.core.nth.call(null,vec__1809,(2),null);
var vec__1812 = v;
var x = cljs.core.nth.call(null,vec__1812,(0),null);
var y = cljs.core.nth.call(null,vec__1812,(1),null);
var z = cljs.core.nth.call(null,vec__1812,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__1815,p__1816){
var vec__1817 = p__1815;
var u1 = cljs.core.nth.call(null,vec__1817,(0),null);
var u2 = cljs.core.nth.call(null,vec__1817,(1),null);
var u3 = cljs.core.nth.call(null,vec__1817,(2),null);
var vec__1820 = p__1816;
var v1 = cljs.core.nth.call(null,vec__1820,(0),null);
var v2 = cljs.core.nth.call(null,vec__1820,(1),null);
var v3 = cljs.core.nth.call(null,vec__1820,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__1823_SHARP_){
return (p1__1823_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__1824_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__1825_SHARP_,angle_lr),angle_ud);
...
var map__1827 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__1827__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__1827__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__1829 = cljs.core._EQ_;
var expr__1830 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__1829.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__1830))){
return straight;
} else {
if(cljs.core.truth_(pred__1829.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__1830))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__1829.call(null,quil.middlewares.navigation_3d.space,expr__1830))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__1829.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__1830))){
return up;
} else {
if(cljs.core.truth_(pred__1829.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__1830))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__1829.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__1830))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__1827,map__1827__$1,up,straight){
return (function (p1__1826_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__1826_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__1827,map__1827__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__1832_SHARP_);
});})(initial_state))
);
});
/**
...
var map__1833_1844 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__1833_1845__$1 = ((((!((map__1833_1844 == null)))?(((((map__1833_1844.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1833_1844.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1833_1844):map__1833_1844);
var vec__1834_1846 = cljs.core.get.call(null,map__1833_1845__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_1847 = cljs.core.nth.call(null,vec__1834_1846,(0),null);
var c_y_1848 = cljs.core.nth.call(null,vec__1834_1846,(1),null);
var c_z_1849 = cljs.core.nth.call(null,vec__1834_1846,(2),null);
var vec__1837_1850 = cljs.core.get.call(null,map__1833_1845__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_1851 = cljs.core.nth.call(null,vec__1837_1850,(0),null);
var u_y_1852 = cljs.core.nth.call(null,vec__1837_1850,(1),null);
var u_z_1853 = cljs.core.nth.call(null,vec__1837_1850,(2),null);
var vec__1840_1854 = cljs.core.get.call(null,map__1833_1845__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_1855 = cljs.core.nth.call(null,vec__1840_1854,(0),null);
var p_y_1856 = cljs.core.nth.call(null,vec__1840_1854,(1),null);
var p_z_1857 = cljs.core.nth.call(null,vec__1840_1854,(2),null);
quil.core.camera.call(null,p_x_1855,p_y_1856,p_z_1857,(p_x_1855 + c_x_1847),(p_y_1856 + c_y_1848),(p_z_1857 + c_z_1849),u_x_1851,u_y_1852,u_z_1853);
