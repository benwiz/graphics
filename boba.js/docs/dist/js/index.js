...
var _boba = __webpack_require__(2);

var Boba = _interopRequireWildcard(_boba);

var _dat = __webpack_require__(6);
...
var options = Boba.getDefaultOptions();
...
// dat.GUI
//
var restart = function restart(_value) {
  Boba.stop();
  Boba.start(options);
};

var gui = new Dat.GUI();
gui.add(options, 'numVertices', 0, 100).step(1).onChange(restart);
