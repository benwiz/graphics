(ns com.benwiz.squiggle.delaunay
  (:require [clojure.set]))

; A copy of https://github.com/trystan/delaunay-triangulation/blob/master/src/delaunay_triangulation/core.cljc
; I originally copied this because there is an as-of-yet unidentified bug in here when the points are messier
; than a simple grid.
